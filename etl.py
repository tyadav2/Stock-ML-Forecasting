...
Original file is located at
    https://colab.research.google.com/drive/1QHy_y99JsjIEI8R7LyBoCAI_i6HcOIfv
"""
...
def extract(vantage_api_key, symbols):
    ...
    for symbol in symbols:
        ...
        data[symbol] = stock_data  # Store each symbol data in the dictionary
    return data
...
def transform(data, symbols):
    results = []
    for symbol in symbols:
        for date, stock_info in data[symbol]["Time Series (Daily)"].items():
            stock_info["date"] = date
            stock_info["symbol"] = symbol  # Add the symbol dynamically
