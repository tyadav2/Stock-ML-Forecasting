...
Original file is located at
    https://colab.research.google.com/drive/1o5OIESYkbp77nTG-jPOu7XWvjLVil6jj
"""
...
#task to train the ML model in Snowflake with stock data
@task
def train(train_input_table, train_view, forecast_function_name):
    ...
    try:
        ...
        # Inspecting the accuracy metrics of the model.
...
#task to create prediction model to predict the stock prices for next 7 days
@task
...
#creating DAG for ML prediction of stock data, scheduled to run daily
with DAG(
    dag_id = 'TrainPredict',
    start_date = datetime(2024,10,5),
    catchup=False,
    tags=['ML', 'ELT', 'Lab1', 'Snowflake_SQL'],
    schedule = '@daily'
) as dag:

    train_input_table = "dev.raw_data.stock_price"
    ...
    # Creating the tasks and assigning to variables
    ...
    # Setting the task dependencies to ensure that predict_task runs after train_task
